        ...
        <form name="contact" method="POST" action="/success" class="w-full lg:w-2/3 flex flex-col m-auto mt-6" netlify>
            ...
            <div class="flex flex-col md:flex-row">
                ...
                <div class="w-full field flex items-center border-b border-b-2 border-grey-light my-4">
                    <input id="email" name="email" type="email" class="appearance-none bg-transparent border-none w-full text-grey-darker p-2 focus:bg-grey-lighter" required>
            ...
            <div class="field flex items-center border-b border-b-2 border-grey-light my-4">
                <input id="subject" name="subject" type="text" class="appearance-none bg-transparent border-none w-full text-grey-darker p-2 focus:bg-grey-lighter" required>
            ...
            <div class="field flex flex-col border-b border-b-2 border-grey-light my-4">
                <textarea id="message" name="message" rows="9" class="appearance-none bg-transparent border-none w-full text-grey-darker p-2 focus:bg-grey-lighter resize-none" required></textarea>
