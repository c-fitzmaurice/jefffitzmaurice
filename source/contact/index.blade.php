...
<div class="text-center">
    ...
    <form name="contact" method="POST" action="/success" class="w-full lg:w-2/3 flex flex-col m-auto mt-6" netlify>
        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="w-full field flex items-center border-b-2 border-grey-light my-4">
        ...
        <div class="field flex items-center border-b-2 border-grey-light my-4">
        ...
        <div class="field flex flex-col border-b-2 border-grey-light my-4">
