...
@section('body')
    ...
    <article class="flex flex-col flex-col-reverse md:flex-row mt-8">
        <div class="w-full md:w-1/2 pr-4">
            <p class="mb-4 leading-loose">Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Nullam quis risus eget urna mollis ornare vel eu leo. Donec ullamcorper nulla non metus auctor fringilla.</p>
