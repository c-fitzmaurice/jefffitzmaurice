...
@section('body')
    ...
    <article class="flex flex-col flex-col-reverse md:flex-row mt-8">
        <div class="w-full md:w-1/2 pr-4 about">
            <p>It has been a real pleasure and an honor over the years having the privilege of creating illustrations for many of the highest profile companies, brands, advertising agencies and publishers in the country.</p>
            <p>That experience has also given me the enjoyable opportunity to work for and collaborate with many very talented art directors and designers to whom I owe thanks and appreciation.</p>
